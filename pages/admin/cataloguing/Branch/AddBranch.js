...
const AddBranch = () => {
    ...
    const onSubmitHandler = ()=>{
        ...
        console.log("BranchZip :", BranchZip)
        console.log("BranchCity :", BranchCity)
        console.log("BranchState :", BranchState)
        console.log("BranchCountry :", BranchCountry)
        console.log("BranchFax :", BranchFax)
        console.log("BranchPhone :", BranchPhone)
        console.log("BranchUrl :", BranchUrl)
        console.log("BranchIp :", BranchIp)
                ...
                <form className="formValidate0" id="formValidate0" method="get">
                  <div className="row">
                    ...
                    <div className="input-field col s12">
                      ...
                      <input className="validate" required id="uname1" name="uname1" type="number" 
                    ...
                    <div className="input-field col s12">
                      ...
                      <input className="validate" required id="uname4" name="uname4" type="text" 
                    ...
                    <div className="input-field col s12">
                      <label htmlFor="uname9">The geolocalisation address of the Branch*</label>
                    ...
                    <div className="input-field col s12">
                        <SelectBox  id="uname10" name="uname10" className="validate" label={"Library"}
                        value={Library} onChange={e => setLibrary(e.target.value)} required>
                    ...
                    <div className="input-field col s12">
                      <button className="btn waves-effect waves-light right submit" type="submit" onClick={onSubmitHandler} name="action">Add the Branch
