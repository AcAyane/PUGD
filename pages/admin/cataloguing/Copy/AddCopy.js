...
import {GET_ALL_SECTIONS} from "../../../../graphql/queries/admin/administration/SectionQuerie";
import {GET_ALL_OWNERS} from "../../../../graphql/queries/admin/administration/OwnerQuerie";
import {GET_ALL_MEDIATYPE} from "../../../../graphql/queries/admin/administration/MediatypeQuerie";
...
const AddCopy = () => {
  ...
  const { data: data5 }  = useQuery( GET_ALL_MEDIATYPE);
