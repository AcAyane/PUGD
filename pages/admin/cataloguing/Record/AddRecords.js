    ...
    const onSubmitHandler = ()=>{
      ...
      AddRecord({
          variables: {
            ...
            OtherPublisher:OtherPublishers.split("\"")[1],
            CollectionTitle:c,
            ClassNumber:a,
         ...
         {/* HTML VALIDATION  */}
            ...
            <div className="card-content">
              ...
              <h6  >Uniform Titles</h6>
                    <div className="input-field col s12">
                        <SelectBox multiple  setInstance={setCollectionTitle} className="validate" 
                    ...
                    <div className="input-field col s6">
                        <SelectBox   multiple="multiple"  label={"Language of publication"} className="validate" 
                    ...
                    <div className="input-field col s6">
                        <SelectBox   multiple="multiple" className="validate" label={"Original Language"}
