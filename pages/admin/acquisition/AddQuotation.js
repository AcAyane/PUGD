...
class AddQuotation extends React.Component {
  constructor(props) {
    super(props);
    this.state = { order_line: [b1], type: "quotation" };
    this.createOrderLine = this.createOrderLine.bind(this);
  }
          ...
          <div>
            ...
            <Formik
              ...
              onSubmit={(values, actions) => {
                new Promise((resolve) => {
                  setTimeout(() => {
                    // <Mutation mutation={InsertOrderLine}>
                    //   {(insertOrderLine) => (
                    for (var i = 0; i < this.state.order_line.length; i++) {
                      this.createOrderLine(this.state.order_line[i]);
                    }
                    //   )}
                    // </Mutation>
                    resolve(this.state.order_line);
                  }, 2000);
                ...
                //   actions.setSubmitting(false);
                // }, 1000);
                alert(`${this.state.type} added succesfully`);
              }}
...
export default compose(
  ...
  // graphql(InsertOrder, { name: "insertOrder" }),
