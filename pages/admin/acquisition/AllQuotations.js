  ...
  render() {
    ...
    return (
      <div>
              ...
              <div className="row">
                <div className="col s12 m6">
                  <div className="card-title">
                    <h4>Purchasing Management : Quotations</h4>
                  </div>
                </div>
                <div className="col s12 m6">
                  <button
        ...
        <Query query={GetOrders} variables={{ type: typeord }}>
          {({ loading, error, data }) => {
                                ...
                                <td>
                                  <button
                                    ...
                                    onClick={() =>
                                      Router.push({
                                        pathname:
                                          "/admin/acquisition/UpdateQuotations",
                                        query: {
                                          id: this.splitfunction(item._id),
                                        },
                                      })
                                    }
                                  >
...
export default withApollo({ ssr: true })(AllQuotations);
