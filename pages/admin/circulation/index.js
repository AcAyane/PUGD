...
import {GET_GROUPS_BORREWORS} from "../../../graphql/queries/admin/Ciruclation/GroupsBorrewors";
import {useLazyQuery, useQuery} from "@apollo/react-hooks";


const CirculationHome = () => {

    const { loading, error, data } = useLazyQuery(GET_GROUPS_BORREWORS);
                            ...
                            <div className="row">
                                ...
                                <Grid>
                                    ...
                                    <GridElement s={12} style={{ display: "flex"}}>
                                        ...
                                        <DatePicker label={"Adhésion Fain"}/>
