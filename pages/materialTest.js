    ...
    <div>
      <header className="page-topbar" id="header">
        <div className="navbar2 navbar2-fixed">
          <nav className="navbar2-main navbar2-color nav-collapsible sideNav-lock navbar2-dark gradient-45deg-purple-deep-orange gradient-shadow">
            <div className="nav-wrapper">
              <ul className="navbar2-list right"></ul>
            </div>
          </nav>
        </div>
      </header>
      ...
      <aside className="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light navbar2-full sidenav-active-rounded">
        <div className="brand-sidebar">
          <h1 className="logo-wrapper">
            ...
            <a className="navbar2-toggler" href="#"></a>
          </h1>
        </div>
        <ul
          className="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow ps ps--active-y"
          id="slide-out"
