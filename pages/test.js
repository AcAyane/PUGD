            ...
            <div className="nav-wrapper">
              ...
              <ul className="navbar-list right">
                <li className="dropdown-language">
                  ...
                  data-target="translation-dropdown"  ref={buttonRef}>
                ...
                <li className="hide-on-large-only search-input-wrapper"><a
                  className="waves-effect waves-block waves-light search-button" href="javascript:void(0);"><i
              ...
              <ul className="dropdown-content" id="translation-dropdown">
                <li className="dropdown-item"><a className="grey-text text-darken-1" href="#!" data-language="en"><i
                  className="flag-icon flag-icon-gb"></i> English</a></li>
                <li className="dropdown-item"><a className="grey-text text-darken-1" href="#!" data-language="fr"><i
                  className="flag-icon flag-icon-fr"></i> French</a></li>
                <li className="dropdown-item"><a className="grey-text text-darken-1" href="#!" data-language="pt"><i
                  className="flag-icon flag-icon-pt"></i> Portuguese</a></li>
                <li className="dropdown-item"><a className="grey-text text-darken-1" href="#!" data-language="de"><i
              ...
              <ul className="dropdown-content" id="notifications-dropdown">
                ...
                <li><a className="black-text" href="#!"><span className="material-icons icon-bg-circle teal small">settings</span>
                Settings updated</a>
                  <time className="media-meta grey-text darken-2" dateTime="2015-06-12T20:50:48+08:00">4 days ago</time>
                </li>
                <li><a className="black-text" href="#!"><span
                  className="material-icons icon-bg-circle deep-orange small">today</span> Director meeting started</a>
                  <time className="media-meta grey-text darken-2" dateTime="2015-06-12T20:50:48+08:00">6 days ago</time>
                </li>
                <li><a className="black-text" href="#!"><span
                  className="material-icons icon-bg-circle amber small">trending_up</span> Generate monthly report</a>
              ...
              <ul className="dropdown-content" id="profile-dropdown">
                ...
                <li><a className="grey-text text-darken-1" href="app-chat.html"><i
                  className="material-icons">chat_bubble_outline</i> Chat</a></li>
                <li><a className="grey-text text-darken-1" href="page-faq.html"><i className="material-icons">help_outline</i>
                Help</a></li>
                <li className="divider"></li>
                <li><a className="grey-text text-darken-1" href="user-lock-screen.html"><i
                  className="material-icons">lock_outline</i> Lock</a></li>
                <li><a className="grey-text text-darken-1" href="user-login.html"><i className="material-icons">keyboard_tab</i>
                Logout</a></li>
              </ul>
            </div>
              ...
              <div className="nav-wrapper">
                <form id="navbarForm">
                  <div className="input-field search-input-sm">
                    ...
                    <label className="label-icon"><i className="material-icons search-sm-icon">search</i></label><i
