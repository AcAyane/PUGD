        ...
        <React.Fragment>
            <header className="page-topbar" id="header">
                <div className="navbar navbar-fixed">
                    <nav className={`"navbar-main navbar-color nav-collapsible navbar-dark gradient-45deg-purple-deep-orange gradient-shadow nav-expanded"`}>
                ...
                <nav className="grey center lighten-5">
